<template>
    <div id="app">
        <div v-if="selectedQuiz">
            <QuizDetail :selectedQuiz="selectedQuiz" @questionCreatedToApp="questionCreated" @goBack="showAllQuizzes"
                @deleteQuiz="deleteQuiz" @deleteQuestion="deleteQuestionFromQuiz" />
        </div>
